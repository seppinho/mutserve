 ...
 * 
 * public BaseAnnotate(String[] args) { super(args); // TODO Auto-generated
 * constructor stub }
 * 
 ...
 * 
 * assertEquals(12, table.getColumns().getSize()); Table table2 =
 * TableBuilder.fromFile(annotation, '\t'); assertEquals(24,
 * table2.getColumns().getSize()); table.merge(table2, "Mutation");
 * assertEquals(35, table.getColumns().getSize()); assertEquals(83,
