...
public class BaseAnnotate extends Tool {
	...
	public BaseAnnotate(String[] args) {
		super(args);
	...
	public void createParameters() {
		...
		addParameter("annotation", "input annotation file, e.g. in resources: ");
	...
	public int run() {
		...
		table = TableBuilder.fromFile(input, '\t');
		table.getColumns().append(new StringColumn("Mutation"), new IBuildValueFunction() {
			  public String buildValue(Row row) throws IOException {
				    return row.getInteger("Pos") + row.getString("Variant");
				  }
				}); 
	...
	public static void main(String[] args) {
		...
		annoTool = new BaseAnnotate(new String[] { "--input", "test-data/mtdna/mixtures/M4-M5.txt", "--annotation",
				"test-data/mtdna/annotation/annotation_2020-08-14.txt", "--output", "test-data/mtdna/annotation/M4-M5-annotated.txt"});
